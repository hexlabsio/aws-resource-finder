...
class AwsResourceFinderKMS(
    ...
    fun kmsResources(region: String, account: String): List<AwsResource.Relationships<KmsInfo>>{
        ...
        return AwsResource.Finder
                ...
                .map {
                    ...
                    AwsResource.Relationships(AwsResource(keyArn, KmsInfo()))
                }
    }
     class KmsInfo: AwsResource.Info
}