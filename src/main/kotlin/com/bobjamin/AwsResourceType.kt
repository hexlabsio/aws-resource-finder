...
enum class AwsResourceType(val service: AwsService, val resource: String, val type: String, val arnSeparator: Char = '/', val hasRegion: Boolean = true, val hasAccount: Boolean = true){
